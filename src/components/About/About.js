  ...
  render() {
    return (
      <div>
        ...
        <Link className="subnavlinks" to="/about"><h3>About</h3></Link>
        <Link className="subnavlinks" to="/about/history"><h3>History</h3></Link>
        <Link className="subnavlinks" to="/about/contact"><h3>Contact</h3></Link>
        </div>
        <div className='box'>
        <Switch>
